...
servers['Middleware'].prototype.removeTileSubdomain = function(host) {
...
servers['Middleware'].prototype.hostInfo = function(req, res, next) {
...
servers['Middleware'].augment({
    initialize: function(parent, app) {
        ...
        this.use(_(this.hostInfo).bind(this));
    },
});
